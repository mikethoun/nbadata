...
class DataNbaGameItem(object):
    ...
    def __init__(self, item):
        ...
        self.date_time_utc = datetime.strptime(f"{self.date} {self.utc_time}", "%Y-%m-%d %H:%M")
        ...
        self.home_score = int(item.get("h", {}).get("s", 0) or 0)
        ...
        self.away_score = int(item.get("v", {}).get("s", 0) or 0)
